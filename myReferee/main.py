...
from myReferee.server.game import RemoteGame

from .cascade import Cascade       # added!
...
def main(cascade: Cascade, options: Namespace|None=None):
    if options is None:
        options = get_options()
